...
public class ParsePlugin extends CordovaPlugin {
    ...
    public static void initializeParseWithApplication(Application app) {
        ...
        //Turning this off will supress the parse push notification
        //PushService.setDefaultPushCallback(app.getBaseContext(), PumpUp.class);
    }
